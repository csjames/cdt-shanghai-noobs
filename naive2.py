				...
				for j in i:
					...
					if j < HAPPY_WALKING_DISTANCE:
						if pickupDistances[x][y] < HAPPY_WALKING_DISTANCE:
							...
							# eliminate this row column pair and increment the x and y by setting to very large value
							# number must be greater than the happy walking distance (1000Km)
							...
							# print(np.arange(10, 10+dropoffDistances.shape[1], dtype=float))
							# print(dropoffDistances)
							y = y+1
							continue
					y = y + 1
				x = x + 1
